package ru.vo1d.timetablemanager.ui.sections.timetable.sessions.edit
...
import ru.vo1d.timetablemanager.ui.sections.timetable.sessions.setup.SessionSetupFragment
...
class SessionEditFragment : SessionSetupFragment() {
    ...
    companion object {
        ...
        private fun <T> ArrayAdapter<T>.findIndex(predicate: (T) -> Boolean): Int {
